...
@section('content')
    <div class="kt-portlet">
        <div class="kt-portlet__head">
            ...
            <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-actions">
                    <a href="{{ route('admin.student.export-sample') }}" class="btn btn-success btn-pill btn-sm">
        ...
        {{ html()->modelForm(null, 'post')->acceptsFiles()->route('admin.student.store-import')->class('kt-form kt-form--label-right')->open() }}
