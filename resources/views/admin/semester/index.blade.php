...
@section('content')
    <div class="kt-portlet">
        ...
        <div class="kt-portlet__body">
            <table class="table table-striped table-bordered table-hover table-checkable order-column dataTable no-footer table-responsive" width="100%" id="semester-table">
                <thead>
                <tr>
                    <th>#</th>
                    <th>Name</th>
